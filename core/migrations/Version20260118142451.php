 ...
 */
final class Version20260118142451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification_intent ADD CONSTRAINT FK_7ACB054C72F5A1AA FOREIGN KEY (channel_id) REFERENCES notification_channel (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE notification_subscription DROP FOREIGN KEY FK_A2C88EE672F5A1AA');
        $this->addSql('ALTER TABLE notification_subscription ADD CONSTRAINT FK_A2C88EE672F5A1AA FOREIGN KEY (channel_id) REFERENCES notification_channel (id) ON DELETE CASCADE');
    }
