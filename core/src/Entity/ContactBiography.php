...
#[ORM\Entity(repositoryClass: ContactBiographyRepository::class)]
#[ApiResource(
    security: "is_granted('ROLE_USER')",
    normalizationContext: ['groups' => ['contact_biography:read']],
    denormalizationContext: ['groups' => ['contact_biography:create', 'contact_biography:update']],
)]
...
class ContactBiography implements TenantAwareInterface
{
    use TenantAwareTrait;

    #[Groups(['contact:read', 'contact_biography:read'])]
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    private ?int $id = null;

    #[Groups(['contact_biography:read', 'contact_biography:create'])]
    #[ORM\ManyToOne(inversedBy: 'contactBiographies')]
