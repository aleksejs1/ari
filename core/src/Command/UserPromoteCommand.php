...
class UserPromoteCommand extends Command
{
    ...
    {
        $this
            ->addArgument('uuid', InputArgument::REQUIRED, 'The UUID of the user to promote');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (in_array('ROLE_ADMIN', $roles, true)) {
            $io->note(sprintf('User "%s" is already an admin.', $uuid));
        ...
        $io->success(sprintf('User "%s" has been promoted to ADMIN.', $uuid));
