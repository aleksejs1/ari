...
module.exports = {
  forbidden: [
    ...
    /* architectural rules */
    {
      ...
      severity: 'error',
      comment: 'Lib should not depend on features. Lib is a base layer.',
      from: { path: '^src/lib' },
    ...
    },
    {
      ...
      severity: 'error',
      comment: 'Hooks should not depend on features. Hooks should be reusable.',
      from: { path: '^src/hooks' },
      to: { path: '^src/features' },
    },
    {
      name: 'no-contexts-to-features',
      severity: 'error',
      comment: 'Contexts should not depend on features to avoid circular dependencies.',
    ...
    },
    {
      ...
      severity: 'error',
      comment: 'Generic components should not depend on features.',
...
// generated: dependency-cruiser@17.3.5 on 2025-12-25T13:50:07.107Z
