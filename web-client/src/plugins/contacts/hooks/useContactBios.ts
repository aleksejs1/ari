...
export const useUpdateContactBiography = createMutation(
  async ({ id, data }: { id: string; data: Partial<ContactBiography> }) => {
...
export const useDeleteContactBiography = createMutation(
  async (id: string) => {
