...
export const useUpdateContactAddress = createMutation(
  async ({ id, data }: { id: string; data: Partial<ContactAddress> }) => {
...
export const useDeleteContactAddress = createMutation(
  async (id: string) => {
